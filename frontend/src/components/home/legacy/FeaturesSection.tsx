...
//   return (
//     <div className="group flex flex-col rounded-2xl bg-white p-6 shadow-sm shadow-slate-200 ring-1 ring-slate-100 transition-transform transition-shadow hover:-translate-y-1 hover:shadow-xl hover:shadow-teal-100">
//       <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-2xl bg-teal-50 text-accent">
//         {icon}
//       </div>
