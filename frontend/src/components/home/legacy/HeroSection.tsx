...
//           <Link
//             href="/chat"
//             className="mx-auto block max-w-md transition-opacity hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-2 rounded-3xl"
