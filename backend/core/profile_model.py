"""
User profile model: dietary_preference, allergens, religious_preferences, lifestyle.
Persisted by user_id; used to build restriction_ids for ComplianceEngine.

Field mapping (frontend ↔ backend):
  - dietary_preference ↔ dietary_preference (primary diet: "Hindu Veg", "Vegan", etc.)
  - allergens ↔ allergens (list: ["milk", "peanut", ...])
  - religious_preferences ↔ religious_preferences (list: ["halal", "kosher", ...])
...
class UserProfile:
    ...
    def update_merge(self, **kwargs: Any) -> None:
        ...
        for key, value in kwargs.items():
            ...
            elif key == "religious_preferences":
                self.religious_preferences = list(value) if value else []
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "religious_preferences": list(self.religious_preferences),
    ...
    def from_dict(cls, data: dict) -> "UserProfile":
        ...
        return cls(
            ...
            religious_preferences=list(data.get("religious_preferences") or []),
